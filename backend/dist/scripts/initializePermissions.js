...
async function initializePermissions() {
    try {
        ...
        await permissionService_1.PermissionService.initializePermissions();
        console.log('✅ Permissions and roles initialized successfully!');
        // Create a super admin user if none exists
        const superAdminExists = await database_1.prisma.user.findFirst({
...
//# sourceMappingURL=initializePermissions.js.map