...
exports.userController = {
    ...
    updateUserRole: async (req, res) => {
        try {
            ...
            const success = await permissionService_1.PermissionService.updateUserRole(userId, role);
            if (!success) {
    ...
    getUserStats: async (req, res) => {
        try {
            const stats = await database_1.prisma.user.groupBy({
                by: ['role'],
                _count: {
                    id: true
                }
            ...
            const verifiedUsers = await database_1.prisma.user.count({
